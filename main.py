...
class MainWindow(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('Sistema de Controle de Expedições - FC Facas Artesanais')
    ...
    def initUI(self):
        ...
        self.btn_adicionar = QPushButton("Novo Cadastro")
        self.btn_editar = QPushButton("Atualizar Dados")
        self.btn_excluir = QPushButton("Excluir")
        self.btn_acessar = QPushButton("Acessar Cadastro")
        ...
        self.footer_signature = QLabel(
            "Software Exclusivo para FC Facas Artesanais - Desenvolvido por MR Solutions.")
