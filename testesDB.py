...
def test_cadastrar_cliente():
    lojaDB.cadastrar_cliente('João da Silva', '12345678900', '987654321', 'Rua A, 123', '12345-678', 'Cidade A')
    cliente = lojaDB.buscar_clientes('João da Silva')[0]
    assert cliente[1] == 'João da Silva', "Erro no cadastro de cliente"
    assert cliente[6] == 'Cidade A', "Erro no cadastro de cidade"

def test_editar_cliente():
    lojaDB.cadastrar_cliente('Maria Oliveira', '09876543211', '123456789', 'Rua B, 456', '87654-321', 'Cidade B')
    cliente = lojaDB.buscar_clientes('Maria Oliveira')[0]
    lojaDB.editar_cliente(cliente[0], 'Maria Oliveira', '09876543211', '987654321', 'Rua B, 789', '87654-321', 'Cidade C')
    cliente_editado = lojaDB.buscar_cliente_por_id(cliente[0])
    assert cliente_editado[4] == 'Rua B, 789', "Erro na edição de endereço"
    assert cliente_editado[6] == 'Cidade C', "Erro na edição de cidade"

def test_excluir_cliente():
    lojaDB.cadastrar_cliente('Pedro Santos', '11223344556', '234567890', 'Rua C, 789', '34567-890', 'Cidade D')
...
def test_registrar_compra():
    lojaDB.cadastrar_cliente('Ana Costa', '22334455667', '345678901', 'Rua D, 101', '45678-901', 'Cidade E')
...
def test_editar_compra():
    lojaDB.cadastrar_cliente('Carlos Almeida', '33445566778', '456789012', 'Rua E, 202', '56789-012', 'Cidade F')
...
def test_excluir_compra():
    lojaDB.cadastrar_cliente('Fernanda Lima', '44556677889', '567890123', 'Rua F, 303', '67890-123', 'Cidade G')
...
def run_tests():
    ...
    clientes = [
        ('João da Silva', '12345678900', '987654321', 'Rua A, 123', '12345-678', 'Cidade A'),
        ('Maria Oliveira', '09876543211', '123456789', 'Rua B, 456', '87654-321', 'Cidade B'),
        ('Pedro Santos', '11223344556', '234567890', 'Rua C, 789', '34567-890', 'Cidade D'),
        ('Ana Costa', '22334455667', '345678901', 'Rua D, 101', '45678-901', 'Cidade E'),
        ('Carlos Almeida', '33445566778', '456789012', 'Rua E, 202', '56789-012', 'Cidade F'),
        ('Fernanda Lima', '44556677889', '567890123', 'Rua F, 303', '67890-123', 'Cidade G')
    ]
    compras = [
